...
public:
  ...
  */
  ...
  Texture *GetColorAttachment(vuint32 attachment) override;
...
private:
  ...
  /**
    ...
    our ResourceManager. These attachments are kept in track when clearing
    the Framebuffer for new attachments.
  */
  std::map<vuint32, Texture *> m_colorAttachments;
