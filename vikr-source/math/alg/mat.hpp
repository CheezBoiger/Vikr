...
private:
  ...
  //  example.
  //
  //  | 1   5   9  13 |     mat[0][0] = 1   mat[1][0] = 5   mat[2][0] = 9    mat[3][0] = 13 
  //  | 2   6  10  14 |     mat[0][1] = 2   mat[1][1] = 6   mat[2][1] = 10   mat[3][1] = 14
  //  | 3   7  11  15 |     mat[0][2] = 3   mat[1][2] = 7   mat[2][2] = 11   mat[3][2] = 15
  //  | 4   8  12  16 |     mat[0][3] = 4   mat[1][3] = 8   mat[2][3] = 12   mat[3][3] = 16
  _Value mat[4][4];
};
} // math
} // vikr
